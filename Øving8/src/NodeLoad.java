...
public class NodeLoad {
    ...
    public void loadNodesFromFile(String filename, ArrayList<Node> nodeList, ArrayList<Edge> edgeList, boolean useCapacity) throws Exception{
        ...
        while (true){
            ...
            int capacity = 0;
            if (useCapacity){
                capacity = Integer.parseInt(currentLineArray[2].trim());
            }
            ...
            edgeList.add(new Edge(newFromNode, newToNode, capacity));
